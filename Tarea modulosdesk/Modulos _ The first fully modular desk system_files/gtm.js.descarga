...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_nonInteraction":false,
      "vtp_overrideGaSettings":false,
      "vtp_eventCategory":"Start a new configuration",
      "vtp_trackType":"TRACK_EVENT",
      "vtp_gaSettings":["macro",2],
      "vtp_eventAction":"Click",
      "vtp_enableUaRlsa":false,
      ...
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"9000123_10",
      "tag_id":9
    },{
      "function":"__lcl",
      "vtp_waitForTags":false,
      "vtp_checkValidation":false,
      "vtp_waitForTagsTimeout":"2000",
      "vtp_uniqueTriggerId":"9000123_11",
      "tag_id":10
    }],
  "predicates":[{
      "function":"_eq",
      ...
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"Start a new configuration"
    },{
      "function":"_eq",
      "arg0":["macro",1],
      "arg1":"gtm.linkClick"
  ...
  "rules":[
    [["if",0,1],["add",0]],
    [["if",2,3,4],["add",1]],
    [["if",3,6],["unless",5],["add",2]],
    [["if",3,7,8],["add",3]],
    [["if",9],["add",4,5,6,7,8,9]]]
},
"runtime":[
[],[]
]};
...
var hc={},ic=null;hc.m="GTM-WWB46CV";var jc=null,kc="//www.googletagmanager.com/a?id="+hc.m+"&cv=1",lc={},mc={};var nc=function(){},oc=function(a){return"function"==typeof a},pc=function(a){return"string"==sa(a)},qc=function(a){return"number"==sa(a)&&!isNaN(a)},rc=function(a){return Math.round(Number(a))||0},sc=function(a){return"false"==String(a).toLowerCase()?!1:!!a},tc=function(a){var b=[];if(na(a))for(var c=0;c<a.length;c++)b.push(String(a[c]));return b},uc=function(a){return a?a.replace(/^\s+|\s+$/g,""):""},vc=function(a,b){if(!qc(a)||!qc(b)||a>b)a=0,b=2147483647;return Math.floor(Math.random()*(b-a+1)+
